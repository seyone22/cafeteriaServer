"""
Django settings for cafeteriaServer project.
...
ALLOWED_HOSTS = ['10.0.2.16', '127.0.0.1', 'localhost', '10.0.2.2']
...
ROOT_URLCONF = 'cafeteriaServer.urls'
...
WSGI_APPLICATION = 'cafeteriaServer.wsgi.application'
